...
class TranscriptionConfig:
    ...
    # single kernel launch per chunk (removes the per-step host launch overhead; outputs are
    # bit-exact with eager execution). Requires CUDA; non-uniform steps fall back to eager.
